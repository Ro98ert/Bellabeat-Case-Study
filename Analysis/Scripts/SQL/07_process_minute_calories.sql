...
# Checking for unrealistic values, observing that min calories goes to 0, suggesting that the device wasn't being worn or was powered off during that minute.
